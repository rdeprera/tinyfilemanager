...
//Application Title
define('APP_TITLE', 'Tiny File Manager forked By M4|4v1t4');
...
$auth_users = array(
    'admin' => '$2y$10$zXsZF3l.tMcvkCPPmn/MEu29ZgKEtIsbWK31PWOly4BI9xrFpSvXi', //admin@123
    'user' => '$2y$10$zXsZF3l.tMcvkCPPmn/MEu29ZgKEtIsbWK31PWOly4BI9xrFpSvXi' //12345
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Tiny File Manager <?php echo VERSION; ?></a> forked By M4|4v1t4</h3>
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a> forked By M4|4v1t4</div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a> forked By M4|4v1t4</div>
        <?php endif; ?>
    </div>
</form>
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Tiny File Manager forked By M4|4v1t4';
